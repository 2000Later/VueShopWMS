...
<div>
  ...
  <el-card class="box-card">
    ...
    <el-table :data="usetList" stripe border
      style="width: 100%">
...
export default {
  ...
  data() {
    ...
    // 验证手机号的规则
    var checkMobile = (ruls, value, callback) => {
      const regMobile = /^(0|86|17951)?(13[0-9]|15[012345679]|17[678]|18[0-9]|14[57])[0-9]{8}$/
